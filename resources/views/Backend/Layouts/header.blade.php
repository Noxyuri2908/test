        ...
        <div class="navbar-header">
            ...
            <ul class="user-menu">
                <li class="dropdown pull-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><span style="color: white;">HI, Admin</span> <span class="caret"></span></a>
        ...
        <li class="parent ">
         ...
         <li class="parent ">
            <a href="{{ route('tag-list') }}">
                <span data-toggle="collapse" href="#sub-item-2"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Tag Management
            </a>
            <ul class="children collapse" id="sub-item-2">
                <li>
                    <a class="" href="{{ route('add-category')}}">
                        <svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Add tag
                    </a>
                </li>
            </ul>           
        </li>
